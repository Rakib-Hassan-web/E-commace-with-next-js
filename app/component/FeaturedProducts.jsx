    ...
    <section id='prodects' className='mt-[147px]  mb-111'>
        <div className="container">
            ...
            <div className='flex items-center justify-between mt-9'>
                ...
                <div className='w-[270px]   shadow-[0px_4px_30px_0px_rgba(31,_38,_135,_0.15)] rounded-md cursor-pointer'>
                    <div className='w-[270px]  bg-[#F6F7FB] flex justify-center items-center'>


                        <Image className='w-[200px] ' src={'/image 1168.png'} width={1j00} height={100}
                            alt='product image' />

                    </div>
                    <div className='pb-5 hover:bg-[#2F1AC4] hover:text-white duration-300'>
                        ...
                        <p className='text-[14px] font-semibold text-[#151875] text-center mt-[15px] font-lato'>Code -
                            Y523201</p>
                        <p className='text-[14px] font-semibold text-[#151875] text-center mt-[8px] font-lato'>$42.00
                        </p>
                    </div>
                </div>
                  ...
                  <div className='w-[270px]   shadow-[0px_4px_30px_0px_rgba(31,_38,_135,_0.15)] rounded-md'>
                    <div className='w-[270px]  bg-[#F6F7FB] flex justify-center items-center'>
                        ...
                        <Image className='w-[200px] ' src={'/image 1168.png'} width={100} height={100}
                            alt='product image' />
