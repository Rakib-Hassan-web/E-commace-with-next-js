    ...
    <section id='prodects' className='mt-[147px]  mb-111'>
        <div className="container">
            ...
            <div className='flex items-center justify-between mt-9'>
                ...
                <div className='w-[270px] h-[351px] shadow-[0px_4px_30px_0px_rgba(31,_38,_135,_0.15)] rounded-md '>
                    ...
                    <p className='text-[14px] font-semibold text-[#151875] text-center mt-[10px] font-lato'>Code -
                        Y523201</p>
